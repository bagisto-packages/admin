            ...
            <div slot="body">
                ...
                <div class="control-group" :class="[errors.has('date_of_birth') ? 'has-error' : '']">
                    ...
                    <span class="control-error"
                          v-if="errors.has('date_of_birth')">@{{ errors.first('date_of_birth') }}</span>
                </div>
                ...
                <div class="control-group" :class="[errors.has('phone') ? 'has-error' : '']">
                    ...
                    <input type="text" class="control" name="phone" value="{{ $customer->phone }}"
                ...
                <div class="control-group">
                    ...
                    <select class="control" name="customer_group_id">
                        @foreach ($customerGroup as $group)
                            <option
                                value="{{ $group->id }}" {{ $selectedCustomerOption == $group->id ? 'selected' : '' }}>
                                {{ $group->name}}
                            </option>
                        @endforeach
                    </select>
