                ...
                <div class="form-container">
                    ...
                    <div class="control-group" :class="[errors.has('gender') ? 'has-error' : '']">
                        ...
                        <select name="gender" class="control" v-validate="'required'"
                            ...
                            <option value=""></option>
                            <option
                                value="{{ __('admin::app.customers.customers.male') }}">{{ __('admin::app.customers.customers.male') }}</option>
                            <option
                                value="{{ __('admin::app.customers.customers.female') }}">{{ __('admin::app.customers.customers.female') }}</option>
                            <option
                                value="{{ __('admin::app.customers.customers.other') }}">{{ __('admin::app.customers.customers.other') }}</option>
                        </select>
                    ...
                    <div class="control-group" :class="[errors.has('date_of_birth') ? 'has-error' : '']">
                        ...
                        <input type="date" class="control" name="date_of_birth" v-validate=""
                    ...
                    <div class="control-group" :class="[errors.has('phone') ? 'has-error' : '']">
                        ...
                        <input type="text" class="control" name="phone" value="{{ old('phone') }}"
