    ...
    <div style="padding: 30px;">
        <div style="font-size: 20px;color: #242424;line-height: 30px;margin-bottom: 34px;">
            <span style="font-weight: bold;">
                {{ __('admin::app.mail.order.cancel.heading') }}
            </span> <br>

            <p style="font-size: 16px;color: #5E5E5E;line-height: 24px;">
                {{ __('admin::app.mail.order.cancel.dear', ['customer_name' => $order->customer_full_name]) }},
            </p>

            <p style="font-size: 16px;color: #5E5E5E;line-height: 24px;">
                {!! __('admin::app.mail.order.cancel.greeting', [
        ...
        <div style="font-weight: bold;font-size: 20px;color: #242424;line-height: 30px;margin-bottom: 20px !important;">
            {{ __('admin::app.mail.order.cancel.summary') }}
        </div>
        ...
        <div
            ...
            <div style="line-height: 25px;">
                <div style="font-weight: bold;font-size: 16px;color: #242424;">
                    {{ __('admin::app.mail.order.cancel.shipping-address') }}
                </div>
                ...
                <div style="margin-bottom: 40px;">
                    {{ __('admin::app.mail.order.cancel.contact') }} : {{ $order->shipping_address->phone }}
                </div>

                <div style="font-size: 16px;color: #242424; font-weight: bold">
                    {{ __('admin::app.mail.order.cancel.shipping') }}
                </div>
            ...
            <div style="line-height: 25px;">
                <div style="font-weight: bold;font-size: 16px;color: #242424;">
                    {{ __('admin::app.mail.order.cancel.billing-address') }}
                </div>
                ...
                <div style="margin-bottom: 40px;">
                    {{ __('admin::app.mail.order.cancel.contact') }} : {{ $order->billing_address->phone }}
                </div>

                <div style="font-size: 16px; color: #242424; font-weight: bold">
                    {{ __('admin::app.mail.order.cancel.payment') }}
                </div>
        ...
        <div style="font-size: 16px;color: #242424;line-height: 30px;float: right;width: 40%;margin-top: 20px;">
            <div>
                <span>{{ __('admin::app.mail.order.cancel.subtotal') }}</span>
            ...
            <div>
                <span>{{ __('admin::app.mail.order.cancel.shipping-handling') }}</span>
                <span style="float: right;">
            ...
            @foreach (BagistoPackages\Shop\Helpers\Tax::getTaxRatesWithAmount($order, false) as $taxRate => $taxAmount )
                <div>
                    <span
                        id="taxrate-{{ core()->taxRateAsIdentifier($taxRate) }}">{{ __('admin::app.mail.order.cancel.tax') }} {{ $taxRate }} %</span>
            ...
            @if ($order->discount_amount > 0)
                <div>
                    <span>{{ __('admin::app.mail.order.cancel.discount') }}</span>
                    <span style="float: right;">
            ...
            <div style="font-weight: bold">
                <span>{{ __('admin::app.mail.order.cancel.grand-total') }}</span>
                <span style="float: right;">
        ...
        <div style="margin-top: 65px;font-size: 16px;color: #5E5E5E;line-height: 24px;display: inline-block">
            <p style="font-size: 16px;color: #5E5E5E;line-height: 24px;">
                {{ __('admin::app.mail.order.cancel.final-summary') }}
            </p>

            <p style="font-size: 16px;color: #5E5E5E;line-height: 24px;">
                {!!
                    __('admin::app.mail.order.cancel.help', [
            ...
            <p style="font-size: 16px;color: #5E5E5E;line-height: 24px;">
                {{ __('admin::app.mail.order.cancel.thanks') }}
            </p>
        </div>
    </div>
@endcomponent
