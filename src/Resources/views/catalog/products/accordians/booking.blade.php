...
@push('scripts')
    <?php $bookingProduct = app('\BagistoPackages\Shop\Repositories\BookingProductRepository')->findOneByField('product_id', $product->id) ?>
    ...
    <script type="text/x-template" id="booking-information-template">
        <div>
            ...
            <div class="default-booking-section" v-if="booking.type == 'default'">
                @include ('shop::admin.catalog.products.accordians.booking.default', ['bookingProduct' => $bookingProduct])
            </div>

            <div class="appointment-booking-section" v-if="booking.type == 'appointment'">
                @include ('shop::admin.catalog.products.accordians.booking.appointment', ['bookingProduct' => $bookingProduct])
            </div>

            <div class="event-booking-section" v-if="booking.type == 'event'">
                @include ('shop::admin.catalog.products.accordians.booking.event', ['bookingProduct' => $bookingProduct])
            </div>

            <div class="rental-booking-section" v-if="booking.type == 'rental'">
                @include ('shop::admin.catalog.products.accordians.booking.rental', ['bookingProduct' => $bookingProduct])
            </div>

            <div class="table-booking-section" v-if="booking.type == 'table'">
                @include ('shop::admin.catalog.products.accordians.booking.table', ['bookingProduct' => $bookingProduct])
            </div>
    ...
    @include ('shop::admin.catalog.products.accordians.booking.slots')
