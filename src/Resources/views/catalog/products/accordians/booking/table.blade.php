    ...
    <script type="text/x-template" id="table-booking-template">
        <div>
            <div class="control-group" :class="[errors.has('booking[price_type]') ? 'has-error' : '']">
                <label class="required">{{ __('shop::app.admin.catalog.products.charged-per') }}</label>

                <select v-validate="'required'" name="booking[price_type]" v-model="table_booking.price_type" class="control" data-vv-as="&quot;{{ __('shop::app.admin.catalog.products.charged-per') }}&quot;">
                    <option value="guest">{{ __('shop::app.admin.catalog.products.guest') }}</option>
                    <option value="table">{{ __('shop::app.admin.catalog.products.table') }}</option>
                </select>
            ...
            <div v-if="table_booking.price_type == 'table'" class="control-group" :class="[errors.has('booking[guest_limit]') ? 'has-error' : '']">
                <label class="required">{{ __('shop::app.admin.catalog.products.guest-limit') }}</label>

                <input type="text" v-validate="'required|min_value:1'" name="booking[guest_limit]" v-model="table_booking.guest_limit" class="control" data-vv-as="&quot;{{ __('shop::app.admin.catalog.products.guest-limit') }}&quot;"/>
            ...
            <div class="control-group" :class="[errors.has('booking[qty]') ? 'has-error' : '']">
                <label class="required">{{ __('shop::app.admin.catalog.products.guest-capacity') }}</label>

                <input type="text" v-validate="'required|min_value:1'" name="booking[qty]" value="{{ $bookingProduct ? $bookingProduct->qty : 0 }}" class="control" data-vv-as="&quot;{{ __('shop::app.admin.catalog.products.guest-limit') }}&quot;"/>
            ...
            <div class="control-group" :class="[errors.has('booking[duration]') ? 'has-error' : '']">
                ...
                <input type="text" v-validate="'required|min_value:1'" name="booking[duration]" v-model="table_booking.duration" class="control" data-vv-as="&quot;{{ __('shop::app.admin.catalog.products.slot-duration') }}&quot;"/>
            ...
            <div class="control-group" :class="[errors.has('booking[break_time]') ? 'has-error' : '']">
                ...
                <input type="text" v-validate="'required|min_value:1'" name="booking[break_time]" v-model="table_booking.break_time" class="control" data-vv-as="&quot;{{ __('shop::app.admin.catalog.products.break-time') }}&quot;"/>
            ...
            <div class="control-group" :class="[errors.has('booking[prevent_scheduling_before]') ? 'has-error' : '']">
                <label class="required">{{ __('shop::app.admin.catalog.products.prevent-scheduling-before') }}</label>

                <input type="text" v-validate="'required|min_value:1'" name="booking[prevent_scheduling_before]" v-model="table_booking.prevent_scheduling_before" class="control" data-vv-as="&quot;{{ __('shop::app.admin.catalog.products.prevent-scheduling-before') }}&quot;"/>
            ...
            <div class="control-group" :class="[errors.has('booking[same_slot_all_days]') ? 'has-error' : '']">
                ...
                <select v-validate="'required'" name="booking[same_slot_all_days]" v-model="table_booking.same_slot_all_days" class="control" data-vv-as="&quot;{{ __('shop::app.admin.catalog.products.same-slot-all-days') }}&quot;">
