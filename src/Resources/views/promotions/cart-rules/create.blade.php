                                ...
                                <div class="control-group" :class="[errors.has('channels[]') ? 'has-error' : '']">
                                    ...
                                    <select class="control" id="channels" name="channels[]" v-validate="'required'"
                                        ...
                                        @foreach(core()->getAllChannels() as $channel)
                                            <option
                                                value="{{ $channel->id }}" {{ old('channels') && in_array($channel->id, old('channels')) ? 'selected' : '' }}>
                                                {{ $channel->name }}
                                            </option>
                                        @endforeach
                            ...
                            <div slot="body">
                                ...
                                <div class="control-group" :class="[errors.has('action_type') ? 'has-error' : '']">
                                    ...
                                    <select class="control" id="action_type" name="action_type" v-validate="'required'"
                                        ...
                                        <option
                                            value="by_percent" {{ old('action_type') == 'by_percent' ? 'selected' : '' }}>
                                            {{ __('admin::app.promotions.cart-rules.percentage-product-price') }}
                                        </option>
                                        <option
                                            value="by_fixed" {{ old('action_type') == 'by_fixed' ? 'selected' : '' }}>
                                            {{ __('admin::app.promotions.cart-rules.fixed-amount') }}
                                        </option>
                                        <option
                                            value="cart_fixed" {{ old('action_type') == 'cart_fixed' ? 'selected' : '' }}>
                                            {{ __('admin::app.promotions.cart-rules.fixed-amount-whole-cart') }}
                                        </option>
                                        <option
                                            value="buy_x_get_y" {{ old('action_type') == 'buy_x_get_y' ? 'selected' : '' }}>
                                ...
                                <div class="control-group">
                                    ...
                                    <select class="control" id="apply_to_shipping" name="apply_to_shipping"
                                        ...
                                        <option
                                            value="0" {{ ! old('apply_to_shipping') ? 'selected' : '' }}>{{ __('admin::app.promotions.cart-rules.no') }}</option>
                                        <option
                                            value="1" {{ old('apply_to_shipping') ? 'selected' : '' }}>{{ __('admin::app.promotions.cart-rules.yes') }}</option>
                                    </select>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <select class="control" id="free_shipping" name="free_shipping">
                                        <option
                                            value="0" {{ ! old('free_shipping') ? 'selected' : '' }}>{{ __('admin::app.promotions.cart-rules.no') }}</option>
                                        <option
                                            value="1" {{ old('free_shipping') ? 'selected' : '' }}>{{ __('admin::app.promotions.cart-rules.yes') }}</option>
                                    </select>
                                </div>
            ...
            <td class="attribute">
                <div class="control-group">
                    <select :name="['conditions[' + index + '][attribute]']" class="control"
                        ...
                        <optgroup v-for='(conditionAttribute, index) in condition_attributes'
                                  :label="conditionAttribute.label">
                            <option v-for='(childAttribute, index) in conditionAttribute.children'
                ...
                <div v-if="matchedAttribute">
                    ...
                    <div
                        ...
                        <tree-view value-field="id" id-field="id" :name-field="'conditions[' + index + '][value]'"
                                   input-type="checkbox" :items='matchedAttribute.options' :behavior="'no'"></tree-view>
                    </div>
