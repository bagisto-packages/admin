                    ...
                    <accordian :title="'{{ __('admin::app.account.change-password') }}'" :active="true">
                        <div slot="body">
                            <div class="control-group" :class="[errors.has('password') ? 'has-error' : '']">
                                ...
                                <input type="password" v-validate="'min:6'" class="control" id="password"
                            ...
                            <div class="control-group"
                                ...
                                <label
                                    for="password_confirmation">{{ __('admin::app.account.confirm-password') }}</label>
                                <input type="password" v-validate="'min:6|confirmed:password'" class="control"
                    ...
                    <accordian :title="'{{ __('admin::app.account.current-password') }}'" :active="true">
                        <div slot="body">
                            <div class="control-group" :class="[errors.has('current_password') ? 'has-error' : '']">
                                ...
                                <input type="password" v-validate="'required|min:6'" class="control"
