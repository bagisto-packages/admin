                            ...
                            <div slot="body">
                                ...
                                <div class="summary-comment-container">
                                    <div class="comment-container">
                                        <form action="{{ route('admin.sales.orders.comment', $order->id) }}"
                                            ...
                                            <div class="control-group"
                                                ...
                                                <label for="comment"
                                                       class="required">{{ __('admin::app.sales.orders.comment') }}</label>
                                            ...
                                            <div class="control-group">
                                                <span class="checkbox">
                                                    <input type="checkbox" name="customer_notified"
                                                           id="customer-notified" name="checkbox[]">
