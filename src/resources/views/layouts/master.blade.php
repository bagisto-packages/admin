...
<html lang="{{ config('app.locale') }}">
    <head>
        ...
        @else
            <link rel="icon" sizes="16x16" href="{{ asset('vendor/packages/ui/assets/images/favicon.ico') }}" />
        @endif

        <link rel="stylesheet" href="{{ asset('vendor/packages/ui/assets/css/ui.css') }}">
        <link rel="stylesheet" href="{{ asset('vendor/packages/admin/assets/css/admin.css') }}">
    ...
    <body @if (core()->getCurrentLocale() && core()->getCurrentLocale()->direction == 'rtl') class="rtl" @endif style="scroll-behavior: smooth;">
        ...
        <script type="text/javascript" src="{{ asset('vendor/packages/admin/assets/js/admin.js') }}"></script>
