        ...
        <div>
            ...
            <div class="table" style="margin-top: 20px; overflow-x: unset;">
                <table>
                    ...
                    <grouped-product-item v-for='(groupedProduct, index) in grouped_products'
                                          :grouped-product="groupedProduct" :key="index" :index="index"
                                          @onRemoveGroupedProduct="removeGroupedProduct($event)"></grouped-product-item>
    ...
    <script type="text/x-template" id="grouped-product-item-template">
        <tr>
            <td>
                ...
                <input type="hidden" :name="[inputName + '[associated_product_id]']"
                       :value="groupedProduct.associated_product.id"/>
            </td>
            ...
            <td>
                <div class="control-group" :class="[errors.has(inputName + '[qty]') ? 'has-error' : '']">
                    <input type="number" v-validate="'required|min_value:0'" :name="[inputName + '[qty]']"
                           v-model="groupedProduct.qty" class="control"
            ...
            <td>
                <div class="control-group" :class="[errors.has(inputName + '[sort_order]') ? 'has-error' : '']">
                    <input type="number" v-validate="'required|min_value:0'" :name="[inputName + '[sort_order]']"
                           v-model="groupedProduct.sort_order" class="control"
