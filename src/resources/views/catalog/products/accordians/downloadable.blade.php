        ...
        <tr>
            <td>
                <div class="control-group" :class="[errors.has(linkInputTitleName) ? 'has-error' : '']">
                    <input type="text" v-validate="'required'" v-model="link.title" :name="[linkInputTitleName]"
                           class="control" data-vv-as="&quot;{{ __('admin::app.catalog.products.name') }}&quot;"/>
            ...
            <td>
                <div class="control-group" :class="[errors.has(linkInputName + '[price]') ? 'has-error' : '']">
                    <input type="text" v-validate="'min_value:0'" v-model="link.price"
                           :name="[linkInputName + '[price]']" class="control"
            ...
            <td>
                ...
                <div class="control-group" :class="[errors.has(linkInputName + '[file]') ? 'has-error' : '']"
                     v-if="link.type == 'file'">
                    <input type="hidden" v-validate="'required'" :name="[linkInputName + '[file]']" v-model="link.file"
                           data-vv-as="&quot;{{ __('admin::app.catalog.products.file') }}&quot;"/>

                    <input type="hidden" :name="[linkInputName + '[file_name]']" v-model="link.file_name"/>

                    <input type="file" class="control" :id="[linkInputName + '[file]']" ref="file"
                           @change="uploadFile('file')" style="display: none"/>

                    <a v-if="link.file_url" :href="link.file_url" style="margin-bottom: 10px; display: block;"
                       target="_blank">
                        @{{ link.file_name | truncate }}
                    </a>

                    <label class="btn btn-black btn-md" :for="[linkInputName + '[file]']"
                ...
                <div class="control-group" :class="[errors.has(linkInputName + '[url]') ? 'has-error' : '']"
                     v-if="link.type == 'url'">
                    <input type="text" v-validate="'required'" v-model="link.url" :name="[linkInputName + '[url]']"
                           class="control" data-vv-as="&quot;{{ __('admin::app.catalog.products.url') }}&quot;"/>
            ...
            <td>
                ...
                <div class="control-group" v-if="link.sample_type == 'file'">
                    <input type="hidden" :name="[linkInputName + '[sample_file]']" v-model="link.sample_file"
                           data-vv-as="&quot;{{ __('admin::app.catalog.products.sampe-file') }}&quot;"/>

                    <input type="hidden" :name="[linkInputName + '[sample_file_name]']"
                           v-model="link.sample_file_name"/>

                    <input type="file" class="control" :id="[linkInputName + '[sample_file]']" ref="sample_file"
                           @change="uploadFile('sample_file')" style="display: none"/>

                    <a v-if="link.sample_file_url" :href="link.sample_file_url"
                       style="margin-bottom: 10px; display: block;" target="_blank">
                        @{{ link.sample_file_name | truncate }}
                    </a>

                    <label class="btn btn-black btn-md" :for="[linkInputName + '[sample_file]']"
                           style="width: auto; text-align: center;">
                        {{ __('admin::app.catalog.products.browse-file') }}
                    </label>
                </div>
                ...
                <div class="control-group" v-if="link.sample_type == 'url'">
                    <input type="text" v-model="link.sample_url" :name="[linkInputName + '[sample_url]']"
                           class="control"/>
                </div>
            </td>
            ...
            <td>
                <div class="control-group" :class="[errors.has(linkInputName + '[downloads]') ? 'has-error' : '']">
                    <input type="number" v-validate="'required|min_value:0'" v-model="link.downloads"
                           :name="[linkInputName + '[downloads]']" class="control"
                           data-vv-as="&quot;{{ __('admin::app.catalog.products.downloads') }}&quot;"/>
            ...
            <td>
                <div class="control-group" :class="[errors.has(linkInputName + '[sort_order]') ? 'has-error' : '']">
                    <input type="number" v-validate="'required|numeric|min_value:0'" v-model="link.sort_order"
                           :name="[linkInputName + '[sort_order]']" class="control"
        ...
        <tr>
            <td>
                <div class="control-group" :class="[errors.has(sampleInputTitleName) ? 'has-error' : '']">
                    <input type="text" v-validate="'required'" v-model="sample.title" :name="[sampleInputTitleName]"
                           class="control" data-vv-as="&quot;{{ __('admin::app.catalog.products.name') }}&quot;"/>
            ...
            <td>
                ...
                <div class="control-group" :class="[errors.has(sampleInputName + '[file]') ? 'has-error' : '']"
                     v-if="sample.type == 'file'">
                    <input type="hidden" v-validate="'required'" :name="[sampleInputName + '[file]']"
                           v-model="sample.file" data-vv-as="&quot;{{ __('admin::app.catalog.products.file') }}&quot;"/>

                    <input type="hidden" :name="[sampleInputName + '[file_name]']" v-model="sample.file_name"/>

                    <input type="file" class="control" :id="[sampleInputName + '[file]']" ref="file"
                           @change="uploadFile('file')" style="display: none"/>

                    <a v-if="sample.file_url" :href="sample.file_url" style="margin-bottom: 10px; display: block;"
                       target="_blank">
                        @{{ sample.file_name | truncate }}
                    </a>

                    <label class="btn btn-black btn-md" :for="[sampleInputName + '[file]']"
                           style="width: auto; text-align: center;">
                        {{ __('admin::app.catalog.products.browse-file') }}
                    </label>
                ...
                <div class="control-group" :class="[errors.has(sampleInputName + '[url]') ? 'has-error' : '']"
                     v-if="sample.type == 'url'">
                    <input type="text" v-validate="'required'" v-model="sample.url" :name="[sampleInputName + '[url]']"
                           class="control" data-vv-as="&quot;{{ __('admin::app.catalog.products.url') }}&quot;"/>
            ...
            <td>
                <div class="control-group" :class="[errors.has(sampleInputName + '[sort_order]') ? 'has-error' : '']">
                    <input type="number" v-validate="'required|numeric|min_value:0'" v-model="sample.sort_order"
                           :name="[sampleInputName + '[sort_order]']" class="control"
                           data-vv-as="&quot;{{ __('admin::app.catalog.products.sort-order') }}&quot;"/>
