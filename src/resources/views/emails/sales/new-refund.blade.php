    ...
    <div style="padding: 30px;">
        <div style="font-size: 20px;color: #242424;line-height: 30px;margin-bottom: 34px;">
            <span style="font-weight: bold;">
                {{ __('admin::app.mail.refund.heading', ['order_id' => $order->increment_id, 'refund_id' => $refund->id]) }}
            </span> <br>
        ...
        <div style="font-weight: bold;font-size: 20px;color: #242424;line-height: 30px;margin-bottom: 20px !important;">
            {{ __('admin::app.mail.refund.summary') }}
        </div>
        ...
        <div style="font-size: 16px;color: #242424;line-height: 30px;float: right;width: 40%;margin-top: 20px;">
            ...
            @if ($refund->adjustment_refund > 0)
                <div>
                    <span>{{ __('admin::app.mail.refund.adjustment-refund') }}</span>
                    <span style="float: right;">
            ...
            @if ($refund->adjustment_fee > 0)
                <div>
                    <span>{{ __('admin::app.mail.refund.adjustment-fee') }}</span>
                    <span style="float: right;">
