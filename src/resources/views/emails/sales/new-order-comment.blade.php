    ...
    <div style="padding: 30px;">
        <div style="font-size: 20px;color: #242424;line-height: 30px;margin-bottom: 34px;">
            <p style="font-size: 16px;color: #5E5E5E;line-height: 24px;">
                {{ __('admin::app.mail.order.comment.dear', ['customer_name' => $comment->order->customer_full_name]) }},
            </p>
        </div>
        ...
        <div style="margin-top: 20px;font-size: 16px;color: #5E5E5E;line-height: 24px;display: inline-block">
            <p style="font-size: 16px;color: #5E5E5E;line-height: 24px;">
                {!!
                    __('admin::app.mail.order.comment.help', [
            ...
            <p style="font-size: 16px;color: #5E5E5E;line-height: 24px;">
                {{ __('admin::app.mail.order.comment.thanks') }}
            </p>
        </div>
    </div>
@endcomponent
